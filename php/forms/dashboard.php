...
<head>
    ...
    <title>FoodGrab Dashboard</title>
        ...
        <footer class="dashboard-footer">
            <div class="footer-upper">
                <div class="footer-left">
                    ...
                    <p class="description">Bringing the city's best flavors to your doorstep. Fast, fresh, and reliable delivery for every craving.</p>
                </div>
