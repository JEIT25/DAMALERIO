<?php
/**
 * Email Configuration for FoodGrab
...
function sendViaMailjet($to, $otp, $config)
{
    ...
    $messageText = "Hello,\n\nYou requested a password reset for your FoodGrab account.\nYour verification code is: {$otp}\nThis code will expire in 15 minutes.\n\nBest regards,\nFoodGrab Team";

    // HTML Template
    $messageHtml = "
    <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;'>
        <div style='text-align: center; margin-bottom: 20px;'>
            <h1 style='color: #FF5722; margin: 0;'>FoodGrab</h1>
            <p style='color: #666; margin-top: 5px;'>Online Food Delivery</p>
        </div>
        <div style='background-color: #f9f9f9; padding: 20px; border-radius: 5px;'>
            <h2 style='color: #333; margin-top: 0;'>Password Reset</h2>
            <p>Hello,</p>
            <p>You requested a password reset for your FoodGrab account.</p>
        ...
        <div style='text-align: center; margin-top: 20px; font-size: 12px; color: #999;'>
            <p>&copy; " . date('Y') . " FoodGrab. All rights reserved.</p>
        </div>
    </div>
    ";
