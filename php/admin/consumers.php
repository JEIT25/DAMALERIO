...
<head>
    ...
    <style>
        ...
        input.error, select.error { border-color: #ef4444 !important; background-color: #fff5f5 !important; }
        ...
        .table-responsive {
            ...
            border: 1px solid var(--border-color);
            background: var(--bg-card);
            min-height: 400px; /* Ensure table area is always visible and spacious */
            flex: 1 0 auto;
        }
        .data-table {
            min-width: 900px; /* Force scroll on small screens to keep content readable */
            width: 100%;
        }
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="dashboard-main">
            <div class="page-header-flex" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; border-bottom: 1px solid #e2e8f0; padding-bottom: 1.5rem;">
                <div>
                ...
                <button class="btn-primary" onclick="openUserModal()" style="white-space: nowrap;"><i class="fa-solid fa-plus" style="margin-right:0.25rem;"></i> Add Consumer</button>
            </div>
            ...
            <div class="pagination-container" style="margin-top: 1.5rem; display: flex; justify-content: space-between; align-items: center; background: #f8fafc; padding: 1rem 1.5rem; border-radius: 12px; border: 1px solid #e2e8f0; flex-wrap: wrap; gap: 1rem;">
                ...
                <div id="paginationControls" style="display: flex; align-items: center; justify-content: flex-end; flex-grow: 1;"></div>
            </div>
        </main>
            ...
            <form id="consumerForm" novalidate style="width: 100%; text-align: left; max-height: 70vh; overflow-y: auto; padding-right: 10px;">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <div class="password-container" style="position:relative;">
                                    ...
                                    <i class="fa-solid fa-eye eye-icon pw-toggle" onclick="togglePasswordVisibility(this)" style="position:absolute; right:12px; top:50%; transform:translateY(-50%); cursor:pointer; color:#94a3b8;"></i>
                                </div>
                ...
                <div class="form-step" id="step3" style="display:none;">
                    <fieldset id="securitySection">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label style="font-weight:600; font-size:0.9rem; margin-bottom:0.4rem; display:block;">Question 1 <span class="security-req" style="color:red;">*</span></label>
                            ...
                            <div class="form-group">
                                <label style="font-weight:600; font-size:0.9rem; margin-bottom:0.4rem; display:block;">Answer 1 <span class="security-req" style="color:red;">*</span></label>
                                <div class="password-container" style="position:relative;">
                            ...
                            <div class="form-group">
                                <label style="font-weight:600; font-size:0.9rem; margin-bottom:0.4rem; display:block;">Question 2 <span class="security-req" style="color:red;">*</span></label>
                            ...
                            <div class="form-group">
                                <label style="font-weight:600; font-size:0.9rem; margin-bottom:0.4rem; display:block;">Answer 2 <span class="security-req" style="color:red;">*</span></label>
                                <div class="password-container" style="position:relative;">
                            ...
                            <div class="form-group">
                                <label style="font-weight:600; font-size:0.9rem; margin-bottom:0.4rem; display:block;">Question 3 <span class="security-req" style="color:red;">*</span></label>
                            ...
                            <div class="form-group">
                                <label style="font-weight:600; font-size:0.9rem; margin-bottom:0.4rem; display:block;">Answer 3 <span class="security-req" style="color:red;">*</span></label>
                                <div class="password-container" style="position:relative;">
        ...
        <div class="modal2-content" style="max-width: 450px;">
            ...
            <form id="blockForm" style="width: 100%; text-align: left;">
                ...
                <div style="display: flex; gap: 0.75rem; margin-top: 1.5rem;">
                    <button type="button" onclick="document.getElementById('blockModal').style.display='none'" class="btn-secondary" style="flex: 1; justify-content: center; padding: 0.6rem; font-size: 0.9rem; border-radius: 8px;">Cancel</button>
                    <button type="submit" id="submitRequestBtn" class="btn-primary" style="background: #dc2626; border-color: #dc2626; flex: 1; justify-content: center; padding: 0.6rem; font-size: 0.9rem; border-radius: 8px;">Submit Request</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div id="messageModal" class="modal2" style="z-index: 2000;">
        <div class="modal2-content" style="max-width: 400px; text-align: center; padding: 2rem;">
            ...
            <button onclick="closeMessageModal()" class="btn-primary" style="width: 100%; justify-content: center; padding: 0.6rem; font-size: 0.9rem; border-radius: 8px;">Okay</button>
        </div>
    </div>
    ...
    <script>
                    ...
                    if (data.consumers.length === 0) {
                        ...
                        data.consumers.forEach(u => {
                            ...
                            html += `<tr class="${isBlocked ? 'blocked-row' : ''}">
                                ...
                                <td>
                                    <div class="action-btns-flex" style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                        <button class="btn-primary" style="padding: 0.4rem 0.8rem; font-size: 0.85rem; display: flex; align-items: center;" onclick="editUser('${u.id}')">
                                            <i class="fa-solid fa-pen-to-square" style="margin-right:0.25rem;"></i> Edit
                                        </button>
                                        ${!isBlocked
                                            ? `<button class="btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.85rem; color: var(--error-color); border-color: var(--error-color); display: flex; align-items: center;" onclick="openBlockModal('${u.id}', 'block')"><i class="fa-solid fa-ban" style="margin-right:0.25rem;"></i>Block</button>`
                                            : `<button class="btn-secondary" style="padding: 0.4rem 0.8rem; font-size: 0.85rem; color: #16a34a; border-color: #16a34a; display: flex; align-items: center;" onclick="openBlockModal('${u.id}', 'unblock')"><i class="fa-solid fa-unlock" style="margin-right:0.25rem;"></i>Unblock</button>`}
                                    </div>
                                </td>
                                <td>
        ...
        document.getElementById('blockForm').onsubmit = function(e) {
            ...
            const endpoint = '/admin_request_block.php';
